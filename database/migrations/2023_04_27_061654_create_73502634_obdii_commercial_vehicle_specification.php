...
return new class extends Migration
{
    ...
    {
        Schema::create('73502634_obdii_commercial_vehicle_specification', function (Blueprint $table) {
            $table->id();
            $table->integer('vehicle_number');
            $table->char('licence_plate',8);
            $table->char('vehicle_brand',10);
    ...
    {
        Schema::dropIfExists('73502634_obdii_commercial_vehicle_specification');
    }
};
